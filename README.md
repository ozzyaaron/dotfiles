...
```bash
git clone https://github.com/dirkkelly/dotfiles.git && cd dotfiles && source bootstrap.sh
```
...
```bash
cd; curl -#L https://github.com/dirkkelly/dotfiles/tarball/master | tar -xzv --strip-components 1 --exclude={README.md,bootstrap.sh,LICENSE-MIT.txt}
```
...
|---|
| [Mathias Bynens](http://dirkkelly.be/) |
